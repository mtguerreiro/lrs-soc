...
#define OCP_PICO_CONFIG_MEM_CPU0_TO_CPU1_ADR		0
#define OCP_PICO_CONFIG_MEM_CPU0_TO_CPU1_SIZE		0

/* Memory for CPU1 to CPU0 data */
#define OCP_PICO_CONFIG_MEM_CPU1_TO_CPU0_ADR		0
#define OCP_PICO_CONFIG_MEM_CPU1_TO_CPU0_SIZE		0

/* RAM for scope data */
#define OCP_PICO_CONFIG_MEM_TRACE_ADR				0
#define OCP_PICO_CONFIG_MEM_TRACE_SIZE_MAX			0
